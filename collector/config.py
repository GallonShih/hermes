...
class Config:
    ...
    # Watchdog settings - restart collection if no activity for this duration
    ...
    STATS_WATCHDOG_TIMEOUT = int(os.getenv('STATS_WATCHDOG_TIMEOUT', 300))  # 5 minutes default
